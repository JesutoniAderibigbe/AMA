...
import 'package:ama/pages/business_reception_pagr/business.dart';
...
class BusinessReceptionPage extends StatefulWidget {
  const BusinessReceptionPage({Key? key}) : super(key: key);

  @override
  State<BusinessReceptionPage> createState() => _BusinessReceptionPageState();
}

class _BusinessReceptionPageState extends State<BusinessReceptionPage> {
  @override
  //Country Picker
  String countryValue = "";
  String? stateValue = "";
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (_) => BusinessPages()));

                          print("navigating to the BusinessPages");
                        },
                        child: Center(
                          child: Row(
                            children: [
